...
public class ProjectList extends AppCompatActivity implements OnItemValueListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  int valfdg = Integer.parseInt("abhi");*/
      ...
      /*  if(p_name.equalsIgnoreCase("default value")){
            ...
            alertdialog("Do you want to continue with"+" "+p_name);
        }*/
                            ...
                            case R.id.p1:
                                ...
                                if (pname!=null){
                                    if(pname.equalsIgnoreCase(p_name)){
                                        ...
                                        // Toast.makeText(ProjectList.this, "Already Current Project"+pname, Toast.LENGTH_SHORT).show();
                                    }else{
