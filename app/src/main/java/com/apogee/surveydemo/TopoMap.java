...
public class TopoMap extends FragmentActivity implements OnMapReadyCallback,TextToSpeech.OnInitListener {
    ...
    TextView status,st,estng,nrthng,devicebtry,zvalt,accuracybasetext,antennaht,hzpcn,vtpcn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // devicebtry=findViewById(R.id.statustopo);
            ...
            public void onClick(View v) {
                new CountDownTimer(2000, 1000) {
                    ...
                    public void onFinish() {
                        String  pointnameee = pname.getText().toString();
                        if(!firstclk){
            ...
            if(data.contains("Battery Status:2.")){
              ...
              //  devicebtry.setText("Battery");
               ...
               // devicebtry.setText("Charging");
                ...
                stopSpeak();
               // devicebtry.setText("Fully Charged");
