...
public class Surveyfragment extends Fragment {
    ...
    int[] imageId = {R.drawable.placeholder, R.drawable.auto, R.drawable.stakepoint, /*R.drawable.stakeline, R.drawable.ppk, R.drawable.area,
    ...
    public void alertdialog(final String msg) {
        ...
        builder1.setNegativeButton(getText(R.string.continue1), new DialogInterface.OnClickListener() {
            @Override
